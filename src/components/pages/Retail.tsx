...
import { Grid, List, Star, Heart, ShoppingCart, SlidersHorizontal, Store } from "lucide-react";
...
// Mock products data for Retail
// In a real app, this would be fetched from API filtered by type="retail"
...
const Retail = () => {
    ...
    // Sort products
    const sortedProducts = [...retailProducts].sort((a, b) => {
        switch (sortBy) {
            case "price-low":
                ...
                <div className="bg-primary py-8">
                    <div className="container">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-white mb-1">{t("retail")}</h1>
                                <p className="text-white/80">{t("exploreBrands")}</p>
                            </div>
                        </div>
                    </div>
                </div>
